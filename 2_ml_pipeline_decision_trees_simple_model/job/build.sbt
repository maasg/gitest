...
organization := "com.example-2_ml_pipeline_decision_trees_simple_model"

name := "2_ml_pipeline_decision_trees_simple_model"
...
packageName in Docker := "2_ml_pipeline_decision_trees_simple_model"
...
name in Debian := "2_ml_pipeline_decision_trees_simple_model"
...
libraryDependencies += "com.databricks" % "spark-csv_2.10" % "1.5.0" excludeAll(
