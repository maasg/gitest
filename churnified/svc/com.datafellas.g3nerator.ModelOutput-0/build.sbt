...
lazy val server = Project(id="server", base = file("server"))
  ...
  .settings(
    mainClass in Compile := Some("com.example.churnified_com.datafellas.g3nerator.modeloutput_0.Main")
  )
  .settings(
  ...
  .settings(
    ...
    packageName in Docker := "churnified-com.datafellas.g3nerator.modeloutput-0",
