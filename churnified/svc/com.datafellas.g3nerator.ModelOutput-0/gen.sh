...
curl -u username:password -X POST "http://localhost:9001/adalog/output/service/library?uuid=6797f88d-19bd-45c7-89d2-631e0df7b717&tpe=model&variable=fittedPipeline&groupId=com.example.churnified_com.datafellas.g3nerator.modeloutput_0&artifactId=client_2.10&version=0.0.1-SNAPSHOT&pck=com.example.churnified_com.datafellas.g3nerator.modeloutput_0"
