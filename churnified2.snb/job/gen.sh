...
echo "enter /tmp/adastyx-new-projects/churnified2.snb/job"

cd /tmp/adastyx-new-projects/churnified2.snb/job

echo "publishing project"
/tmp/adastyx-new-projects/churnified2.snb/sbt/bin/sbt -Dspark.version=1.6.1 -Dhadoop.version=2.6.0 publish

echo "building docker"
/tmp/adastyx-new-projects/churnified2.snb/sbt/bin/sbt -Dspark.version=1.6.1 -Dhadoop.version=2.6.0 docker:publishLocal



echo "pushing docker"
docker push localhost:5000/churnified2.snb:0.0.1-SNAPSHOT
...
curl -X POST -H "Content-type: application/json" http://172.17.0.2:4400/scheduler/iso8601 -d @/tmp/adastyx-new-projects/churnified2.snb/job/src/main/resources/chronos.json
