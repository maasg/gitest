...
lazy val server = Project(id="server", base = file("server"))
  ...
  .settings(
    mainClass in Compile := Some("com.example.churnified2.snb_com.datafellas.g3nerator.modeloutput_0.Main")
  )
  .settings(
  ...
  .settings(
    ...
    packageName in Docker := "churnified2.snb-com.datafellas.g3nerator.modeloutput-0",
