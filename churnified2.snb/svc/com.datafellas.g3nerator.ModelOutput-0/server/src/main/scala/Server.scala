package com.example.churnified2.snb_com.datafellas.g3nerator.modeloutput_0.server.impl
...
import com.example.churnified2.snb_com.datafellas.g3nerator.modeloutput_0.server._

object Server extends Methods {
  private [this] val _ipc = new NettyServer(
                                             new SpecificResponder(classOf[Methods], this),
                                             new InetSocketAddress(25474)
                                           )
...
def tellCatalog():Unit = new Thread { override def run:Unit = {
  ...
  val marathonUrl = "http://172.17.0.6:8080/v2/apps/churnified2.snb/service/com.datafellas.g3nerator.modeloutput-0"
  ...
  h match {
    case Some(host) =>
      ...
      val ch = Http(adalogUrl.get + s"/adalog/output/service?uuid=399f473c-4c02-460d-a96f-f11a3093d599&tpe=model&variable=fittedPipeline&host=${host}&port=25474")
...
val currentProjectJars = Array[String]( "com.example.churnified2.snb_com.datafellas.g3nerator.modeloutput_0.common-0.0.1-SNAPSHOT.jar" , "com.example.churnified2.snb_com.datafellas.g3nerator.modeloutput_0.server-0.0.1-SNAPSHOT.jar" ).map{j => new java.io.File(libDir, j).getAbsolutePath}
val sparkLibDir = new java.io.File(".", "spark-lib")
val fromProjectJars = Array[String]( "commons-collections-3.2.1.jar" , "netty-3.4.0.Final.jar" , "velocity-1.7.jar" , "paranamer-2.3.jar" , "avro-ipc-1.7.7.jar" , "commons-lang-2.6.jar" , "jackson-core-asl-1.9.13.jar" , "avro-compiler-1.7.7.jar" , "jackson-mapper-asl-1.9.13.jar" , "commons-compress-1.4.1.jar" , "snappy-java-1.0.5.jar" , "slf4j-api-1.6.4.jar" , "xz-1.0.jar" , "avro-1.7.7.jar" ).map{j => new java.io.File(sparkLibDir, j).getAbsolutePath}
...
def askOutputToCatalog() = {
  ...
  val h = Http(adalogUrl.get + "/adalog/output?uuid=399f473c-4c02-460d-a96f-f11a3093d599&tpe=model&variable=fittedPipeline")
...
val input = org.apache.spark.mllib.linalg.Vectors.dense(ds)
  ...
  val d = new com.example.churnified2.snb_com.datafellas.g3nerator.modeloutput_0.model.Domain()
   d.setOutput(output) 
