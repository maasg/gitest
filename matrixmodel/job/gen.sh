...
export PKG_NAME=matrixmodel_0.0.2-SNAPSHOT_all.deb
echo "package: /home/maasg/testground/sne/projects/matrixmodel/job/target/matrixmodel_0.0.2-SNAPSHOT_all.deb"

echo "pushing deb package to Adalog UI"
/bin/mkdir -p /tmp/sne/downloads
/bin/cp /home/maasg/testground/sne/projects/matrixmodel/job/target/matrixmodel_0.0.2-SNAPSHOT_all.deb /tmp/sne/downloads
