...
curl -X POST -H "Content-type: application/json" http://chronos-note:4400/scheduler/iso8601 -d @/tmp/adastyx-new-projects/newbum/job/src/main/resources/chronos.json
