...
lazy val server = Project(id="server", base = file("server"))
  ...
  .settings(
    mainClass in Compile := Some("com.example.pipeline_dt_model_final_com.datafellas.g3nerator.modeloutput_0.Main")
  )
  .settings(
  ...
  .settings(
    ...
    packageName in Docker := "pipeline-dt-model-final-com.datafellas.g3nerator.modeloutput-0",
    dockerRepository := Some("localhost:5000"), //Docker
    name in Debian := "pipeline-dt-model-final-com.datafellas.g3nerator.modeloutput-0",
