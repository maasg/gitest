...
def tellCatalog():Unit = new Thread { override def run:Unit = {
  ...
  h match {
    case Some(host) =>
      ...
      val url = "/adalog/output/service?uuid=bbe7efb6-db5f-483f-abe7-341e536f0b34&tpe=model&variable=model&host=${host}&port=19917"
...
val fromProjectJars = Array[String]( "commons-collections-3.2.1.jar" , "avro-ipc-1.7.7.jar" , "avro-1.7.7.jar" , "paranamer-2.3.jar" , "commons-compress-1.4.1.jar" , "commons-lang-2.6.jar" , "avro-compiler-1.7.7.jar" , "slf4j-api-1.6.4.jar" , "jackson-core-asl-1.9.13.jar" , "snappy-java-1.0.5.jar" , "velocity-1.7.jar" , "jackson-mapper-asl-1.9.13.jar" , "netty-3.4.0.Final.jar" , "xz-1.0.jar" ).map{j => new java.io.File(sparkLibDir, j).getAbsolutePath}
