...
lazy val server = Project(id="server", base = file("server"))
  ...
  .settings(
    mainClass in Compile := Some("com.example.pipeline_decision_trees_simple_model_final.snb_com.datafellas.g3nerator.modeloutput_0.Main")
  )
  .settings(
  ...
  .settings(
    ...
    packageName in Docker := "pipeline_decision_trees_simple_model_final.snb-com.datafellas.g3nerator.modeloutput-0",
