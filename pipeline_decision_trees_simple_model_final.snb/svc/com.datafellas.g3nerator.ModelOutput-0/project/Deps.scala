...
object deps {
  ...
  lazy val common = Seq(
    scalaVersion := "2.10.5",
    organization := "com.example.pipeline_decision_trees_simple_model_final.snb_com.datafellas.g3nerator.modeloutput_0",
...
publishTo := Some("Artifactory Realm" at "http://artifactory-node:8082/artifactory/datafellas-jobs/")
  ...
  lazy val server = Seq(
"org.apache.spark" %% "spark-core" % "1.6.2" excludeAll(
    ExclusionRule(organization = "javax.servlet"),
    ExclusionRule(organization = "org.mortbay.jetty"),
...
"org.apache.spark" %% "spark-sql" % "1.6.2" excludeAll(
    ExclusionRule(organization = "javax.servlet"),
    ExclusionRule(organization = "org.mortbay.jetty"),
    ExclusionRule(organization = "org.apache.hadoop")
)
...
"org.apache.spark" %% "spark-yarn" % "1.6.2" excludeAll(
    ExclusionRule(organization = "javax.servlet"),
    ExclusionRule(organization = "org.mortbay.jetty"),
    ExclusionRule("org.apache.hadoop"),
    ExclusionRule("org.apache.ivy", "ivy")
