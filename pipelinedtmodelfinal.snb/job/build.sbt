...
organization := "io.kensu.dtmodel"

name := "pipelinedtmodelfinal.snb"
...
packageName in Docker := "pipelinedtmodelfinal.snb"
...
name in Debian := "pipelinedtmodelfinal.snb"
...
//main class
mainClass in assembly := Some("io.kensu.dtmodel.Main")
