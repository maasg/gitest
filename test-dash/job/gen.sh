...
echo "Telling catalog which notebok library (io.kensu:test-dash_2.10:0.0.3-SNAPSHOT})"
curl -u 'username:password' -X POST "http://localhost:9002/adalog/12408da4-3763-480b-841a-4d4b7d3eeb13/library?uuid=12408da4-3763-480b-841a-4d4b7d3eeb13&groupId=io.kensu&artifactId=test-dash_2.10&version=0.0.3-SNAPSHOT&pkg=io.kensu"



echo "building debian"
/home/maasg/Dev/java/sbt/bin/sbt -Dspark.version=1.6.1 -Dhadoop.version=2.6.0 debian:packageBin
echo "package: /home/maasg/testground/sne/projects/test-dash/job/target/test-dash_0.0.3-SNAPSHOT_all.deb "

echo "pushing deb package to Adalog UI"
[[ -d /tmp/sne/downloads ]] || /bin/mkdir -p /tmp/sne/downloads
[[ -f /home/maasg/testground/sne/projects/test-dash/job/target/test-dash_0.0.3-SNAPSHOT_all.deb ]] && /bin/cp /home/maasg/testground/sne/projects/test-dash/job/target/test-dash_0.0.3-SNAPSHOT_all.deb /tmp/sne/downloads || echo "package file not found !!"
