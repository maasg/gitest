...
echo "Telling catalog which notebok library (io.kensu:test-underscore_2.10:0.0.4})"
curl -u 'username:password' -X POST "http://localhost:9002/adalog/dbd68f8e-89b9-400a-9fc7-2f3dc379d8c2/library?uuid=dbd68f8e-89b9-400a-9fc7-2f3dc379d8c2&groupId=io.kensu&artifactId=test-underscore_2.10&version=0.0.4&pkg=io.kensu"



echo "building debian"
/home/maasg/Dev/java/sbt/bin/sbt -Dspark.version=1.6.1 -Dhadoop.version=2.6.0 debian:packageBin
echo "package: /home/maasg/testground/sne/projects/test_underscore/job/target/test-underscore_0.0.4_all.deb "

echo "pushing deb package to Adalog UI"
[[ -d /tmp/sne/downloads ]] || /bin/mkdir -p /tmp/sne/downloads
[[ -f /home/maasg/testground/sne/projects/test_underscore/job/target/test-underscore_0.0.4_all.deb ]] && /bin/cp /home/maasg/testground/sne/projects/test_underscore/job/target/test-underscore_0.0.4_all.deb /tmp/sne/downloads || echo "package file not found !!"
